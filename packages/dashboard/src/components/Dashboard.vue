    ...
    <div class="p-grid p-fluid dashboard">
        ...
        <div class="p-col-12 p-md-6 p-lg-4 p-fluid contact-form">
            <Panel header="Contact Us">
                <div class="p-grid">
                    <div class="p-col-12">
                        <Dropdown v-model="dropdownCity" :options="dropdownCities" optionLabel="name"
                ...
                <DataTable :value="products" class="p-datatable-customers" :rows="5" style="margin-bottom: 20px"
                    ...
                    <Column>
                        ...
                        <template #body="slotProps">
                            <img :src="'assets/layout/images/product/' + slotProps.data.image"
                                :alt="slotProps.data.image" width="50" />
                        </template>
                    </Column>
